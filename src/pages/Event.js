          ...
          <div className="row text-center row-panel">
            <div className="col-md-10 order-2 order-md-1 pl-5 pr-5 pt-4">
              <div className="mb-5 d-flex mt-2 align-items-center bd-highlight">
                <span className="h2">Event</span> <a href="#" className="btn-create ml-3">Create new +</a>
              </div>
            ...
            <div className="col-md-2 order-1 order-md-2 side-panel text-center">
              <div className="row my-4 text-center text-md-left">
                <div className="col-md-12 d-md-flex pl-4">
                  <img src="" alt=""/>
                  <div className="ml-md-2 ml-lg- mt-2 mt-md-0 mt-lg-0">
                    <h5>Calendar</h5>
                    02 March
                  </div>
                </div>
